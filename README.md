...
```groovy
compile 'kr.ive:offerwall_sdk:1.2.13'
```
...
### 1-4. AndroidManifest.xml 파일의 application에 usesCleartextTraffic를 true로 설정합니다.
...
- targetSDK 28 이상을 사용하는 경우 Android PIE 에서 광고 목록을 불러올 수 없는 문제 수정
